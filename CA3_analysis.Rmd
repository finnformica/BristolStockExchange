...
NB: at a quick glance, SHVR has the highest average (average) profits across all experiments. SNPR does not seem to perform too well which is likely due to it only trading just before the market closes.
...
NB: there is no statistical significance to say that the samples do not follow a Gaussian distribution.
